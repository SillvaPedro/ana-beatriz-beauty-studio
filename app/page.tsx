...
export default function Home() {
  return (
    <div>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-blush-50 via-cream to-gold-50">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
          <div>
            <p className="text-sm font-bold uppercase tracking-widest text-blush-600">
            ...
            <h1 className="mt-4 font-display text-4xl font-bold leading-tight text-ink sm:text-5xl lg:text-6xl">
              ...
              <span className="bg-gradient-to-r from-blush-600 to-gold-500 bg-clip-text text-transparent">
                Ana Beatriz
              </span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/agendamento"
                className="rounded-full bg-gradient-to-r from-blush-600 to-gold-500 px-7 py-3 text-sm font-semibold text-white shadow-md transition-opacity hover:opacity-90"
              >
                Agendar atendimento
              </Link>
              <Link
                href="/cursos"
                className="rounded-full border-2 border-blush-600 px-7 py-3 text-sm font-semibold text-blush-700 transition-colors hover:bg-blush-600 hover:text-white"
              >
                Ver cursos online
              </Link>
            </div>
            <div className="mt-10 flex flex-wrap gap-8">
              ...
              <div>
                ...
                <p className="text-sm text-ink/60">avaliação média</p>
              </div>
            </div>
          </div>
          <div className="relative">
            <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-blush-400 to-gold-400 opacity-30 blur-2xl" />
            <Image
              src="/images/hero.svg"
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="grid gap-6 md:grid-cols-3">
          {services.map((service) => (
            <div
              key={service.title}
              className="rounded-2xl border border-blush-100 bg-white p-7 shadow-sm transition-shadow hover:shadow-lg"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blush-500 to-gold-400 text-white">
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <Link
              href="/portfolio"
              className="text-sm font-semibold text-blush-600 transition-colors hover:text-gold-500"
            >
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-4">
            {portfolioItems.slice(0, 4).map((item) => (
              <div key={item.title} className="group relative overflow-hidden rounded-2xl">
                ...
                />
                <div className="absolute inset-0 flex items-end bg-gradient-to-t from-blush-950/70 to-transparent p-4 opacity-0 transition-opacity group-hover:opacity-100">
                  <div>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2">
          ...
          <div className="order-1 lg:order-2">
            <p className="text-sm font-bold uppercase tracking-widest text-blush-600">Sobre</p>
            <h2 className="mt-2 font-display text-3xl font-bold text-ink sm:text-4xl">
            ...
            <ul className="mt-6 space-y-3">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-ink/80">
                  <svg viewBox="0 0 20 20" className="mt-0.5 h-5 w-5 shrink-0 text-gold-500" fill="currentColor">
            ...
            <a
              ...
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blush-600 to-gold-500 px-7 py-3 text-sm font-semibold text-white shadow-md transition-opacity hover:opacity-90"
            >
              Seguir no Instagram
      ...
      {/* Testimonials */}
      <section className="bg-gradient-to-br from-blush-50 via-cream to-gold-50 py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-sm font-bold uppercase tracking-widest text-blush-600">Depoimentos</p>
            <h2 className="mt-2 font-display text-3xl font-bold text-ink sm:text-4xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {testimonials.map((t) => (
              <figure key={t.author} className="rounded-2xl border border-blush-100 bg-white p-7 shadow-sm">
      ...
      {/* CTA */}
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blush-700 to-gold-600 px-6 py-14 text-center text-white shadow-xl sm:px-12">
          ...
          <div className="relative mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/agendamento"
              className="rounded-full bg-white px-7 py-3 text-sm font-semibold text-blush-700 shadow transition-opacity hover:opacity-90"
            >
              Agendar agora
            </Link>
            <Link
              href="/cursos"
              className="rounded-full border-2 border-white px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-white hover:text-blush-700"
            >
              Conhecer os cursos
            </Link>
          </div>
