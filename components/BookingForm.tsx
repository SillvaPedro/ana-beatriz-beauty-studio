...
export default function BookingForm() {
  ...
  const inputClass =
    "mt-1 w-full rounded-lg border border-blush-200 bg-cream px-4 py-2.5 text-sm text-ink outline-none transition-colors focus:border-blush-500 focus:ring-2 focus:ring-blush-200";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        type="submit"
        className="w-full rounded-full bg-gradient-to-r from-blush-600 to-gold-500 px-7 py-3 text-sm font-semibold text-white shadow-md transition-opacity hover:opacity-90"
      >
